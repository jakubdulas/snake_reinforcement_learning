from SnakeBotQTable import SnakeBot
from SnakeGame import SnakeGame
import time

if __name__ == '__main__':
    playing = True
    bot = SnakeBot('q_table_without_segments.json', True)
    episodes = 5_000
    ...
    for episode in range(start_episode, episodes+1):
        ...
        while playing:
            ...
            action = bot.make_move(state, game.snake.get_possible_actions())
            ...
            game.add_text(f"Time: {round(time.time()-start, 2)}", (30, 135))
            game.add_text(f"Epsilon: {bot.epsilon}", (30, 160))
